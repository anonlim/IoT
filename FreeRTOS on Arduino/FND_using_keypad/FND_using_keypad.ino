...
const int Keypad[4]={2,3,21,20}; //키
const int FndSelectPin[6]={22,23,24,25,26,27};//led
const int FndPin[8]={30,31,32,33,34,35,36,37}; //7seg
const int FndFont[10]={0x3F,0x06,0x5B,0x4F,0x66,
                      0x60,0x7D,0x07,0x7F,0x67};//숫자
